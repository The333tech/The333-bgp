...
- Runtime portal остаётся на Node.js 24 LTS; nginx обновлён внутри stable-линейки до `1.30.4`, а все Alpine-based build/runtime stages — до Alpine `3.24`; базовые образы закреплены immutable multi-arch digest.

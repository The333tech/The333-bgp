...
Если пароль оставить пустым, установщик сгенерирует его автоматически и **покажет один раз**. Сохрани значение сразу: в `.env` записывается только хеш, восстановить исходный пароль из него нельзя.
...
7. ждёт готовность backend, GoBGP и портала до 3 минут;

...
Сам release archive `v0.82.3b` занимает около 350 КБ, а распакованный код и встроенные конфигурации — около 3 МБ. На рабочем стенде Docker images, build cache, данные и backups вместе занимают примерно 1,5–2 ГБ после установки.

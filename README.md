...
The333-BGP поднимает GoBGP speaker на Linux VM, собирает маршруты из готовых источников и модулей сервисов, дедуплицирует/агрегирует их и публикует в MikroTik через BGP. Управление идёт через веб-портал: источники, модули сервисов, Community-профили, диагностика, история, обновления и готовые команды для MikroTik.
...
- **Модули сервисов**: точечные модули для сервисов вроде OpenAI, Anthropic/Claude, YouTube, Google, Telegram, X/Twitter и других.

...
class ReleaseMetadataTests(unittest.TestCase):
    ...
    def test_product_version_is_synchronized_across_release_files(self) -> None:
        ...
        self.assertEqual(badge_block.count("<img "), 3)
        self.assertEqual(badge_block.count("<a "), 3)
        self.assertEqual(badge_block.count("</a><a"), 2)
        self.assertNotIn("&nbsp;", badge_block)
        self.assertNotIn("<ruby>", badge_block)
        self.assertNotIn("<br", badge_block)
